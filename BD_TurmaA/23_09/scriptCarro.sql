create database BDCARRO; -- CRIAR O BANCO DE DADOS
create schema BDCARRO;	

USE BDCARRO; -- ATIVA O BD NA MEMÓRIA PARA UTILIZAR 
...
CREATE TABLE CARRO (
	...
	FOREIGN KEY(idMarca) REFERENCES MARCA (idMarcamarcamarca)
);
